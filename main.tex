...
%In order to do so, agent $i$ needs to compute the following:
%\begin{enumerate}
...
%\vspace{-.2em}
%***Shih-Yun, please remove it as before***
...
%***Shih-Yun, please move it to the middle of the paragraph as we discussed*** 
...
%; as a result, many times agents will prefer trading off computation depth for breadth to achieve better exploration its action profile. 

%***Shih-Yun, please remove it according to what we discussed***
...
%***Shih-Yun,wrong section, please update***
...
%***Shih-Yun, this was not defined yet, please talk in more general terms here, the formal definition is in the next paragraph*** 
to reason about 
...
%***Shih-Yun, please add connection to the former part***
...
%***Shih-Yun, wrong section, please update***~\ref{sec:receding}, 
...
\subsubsection{Dynamic variables, $b^H_t(z^{R})$}% and reciprocity}
...
%\textcolor{red}{***shouldn't it be:(passing$\_$first,yielding), or (yielding$\_$first,passing)?***}
...
%\textcolor{red}{***I need you to explain this paragraph to me***} 
...
%\textcolor{red}{***What does it mean "act compliantly, how?***} 
...
%\textcolor{red}{***What are you trying to say in this subsubsection?***} 
...
%\textcolor{red}{***I did not understand what are you saying in this paragraph***}
Agents perceived other agents' behaviors and update their own type $\theta^H_t$. In social navigation, 
%personal spacing is a common example, as people act repellently more to unfamiliar agents. 
